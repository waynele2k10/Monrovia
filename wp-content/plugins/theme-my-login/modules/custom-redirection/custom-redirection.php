            ...
            switch ($redirection["{$type}_type"]) {
                ...
                case 'referer' :
                    ...
                    if (!empty($_GET['redirect_to'])) {
                        ...
                        if ($secure_cookie && false !== strpos($referer, 'wp-admin'))
                            $referer = preg_replace('|^http://|', 'https://', $referer);
                    } elseif (isset($_COOKIE['first_url1'])) {
                        $referer = '//' . $_COOKIE['first_url1'];
                    } else {
                        $referer = '//' . $_SERVER["SERVER_NAME"] . '/your-profile/';
                    }
