<?php echo '<input type ="hidden" name="q'.$i.'" id="qq'.$i.'" class ="hdHidden" value="0" />';
$qRight = ""; ?>
<ol type="A" class="ans-image">
<?php
		...
		if (${'img'.$x}){
			...
			if (${'img'.$x} != $defaultImage ) {
				...
				echo '</div>';
                            ...
                            echo '<li>';
                            echo '<div class ="imageAnswer '.$qRight.'"><img src = "'.plugin_dir_url( __FILE__ ).'featuredImageDefault.gif"'.' alt =""/></div>';
                            echo '</li>';
