...
$hdQuJ("#hdQuestionnaireContent .question  ol li label").click(function() {
    $hdQuJ(this).parent().parent().find('li').removeClass('selected');
    $hdQuJ(this).parent().addClass('selected');
});