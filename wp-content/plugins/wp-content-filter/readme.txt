=== WP Content Filter ===
Contributors: dgwyer
Tags: replace, words, edit, content filter, filter, filtered, content censor, censor, censored, keywords, options, profanity, swearing, post, admin, abuse, explicit, seo
...
Please <a href="https://wordpress.org/support/view/plugin-reviews/wp-content-filter"><strong>rate</strong></a> this Plugin if you find it useful. It only takes a moment but it's very much appreciated. :)

><strong>Upgrade to <a href="https://wpgoplugins.com/plugins/content-censor/">WP Content Filter</a> today for even more flexible plugin options!
>
>Plus, the Pro version includes a <strong>batch processor</strong> to actively scan your entire site for unwanted content! Checkout the <a href="https://wordpress.org/plugins/wp-content-filter/screenshots/">screenshots</a>, or click <a href="https://wpgoplugins.com/plugins/content-censor/">here</a> for more details.
>
