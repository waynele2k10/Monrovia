...
abstract class MC4WP_Request implements iMC4WP_Request {
	...
	public function get_response_html( ) {
		...
		$img = "";
		if($this->message_type == "subscribed"){
			$img = '<img height="1" width="1" style="border-style:none;" alt="" src="https://api.adsymptotic.com/api/s/trackconversion?_pid=13074&_psign=d0c3440fe7197ebbf600606e9521e2e6&_aid=4198&_lbl=CT&_pc_ev_tp=EmailSignUp"/>';
		}

		$html = '<div class="mc4wp-alert mc4wp-' . esc_attr( $message['type'] ) . '">' . $message['text'] . $img .'</div>';
