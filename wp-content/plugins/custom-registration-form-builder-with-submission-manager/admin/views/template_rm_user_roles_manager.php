...
<form method="post" id="rm_user_role_mananger_form">
    ...
    <div class="rm-upgrade-note">
            ...
            <div class="rm-upgrade-note-content"><img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/blue-cog.png'; ?>"><?php echo RM_UI_Strings::get('MSG_BUY_PRO_USER_ROLE'); ?>
