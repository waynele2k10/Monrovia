<div class="rmagic">
    <div class="operationsbar">
        ...
        <div class="rm-upgrade-note">
            ...
            <div class="rm-upgrade-note-content"><img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/blue-cog.png'; ?>"><?php echo RM_UI_Strings::get('MSG_BUY_PRO_ATT_BROWSER'); ?>
