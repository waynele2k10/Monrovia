...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_NOTIFICATIONS_TO_ADMIN'), "admin_notification", array("yes" => ''), $data['admin_notification'] == 'yes' ? array("id" => "id_rm_admin_notify_cb", "value" => "yes", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_ADMIN_NOTIFS')) : array("id" => "id_rm_admin_notify_cb", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_ADMIN_NOTIFS'))));
        ...
        $form->addElement(new Element_Emailsortable(RM_UI_Strings::get('LABEL_RECIPIENTS_OPTION') . ":", "resp_emails[]", array("id" => "rm_field_value_file_types", "class" => "rm_static_field rm_field_value rm_options_resp_email", "value" => $mails, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_RESPS'))));

        $form->addElement(new Element_HTML('</div>'));


        $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_ENABLE_SMTP'), "enable_smtp", array("yes" => ''), $data['enable_smtp'] == 'yes' ? array("id" => "id_rm_smtp_enable_cb", "value" => "yes", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_ENABLE_SMTP')) : array("id" => "id_rm_smtp_enable_cb", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_NOTE_NOTIFS'))));
        ...
        $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SMTP_AUTH'), "smtp_auth", array("yes" => ''), $data['smtp_auth'] == 'yes' ? array("id" => "id_rm_smtp_auth_cb", "value" => "yes", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_SMTP_AUTH')) : array("id" => "id_rm_smtp_auth_cb", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_SMTP_AUTH'))));
        ...
        $form->addElement(new Element_Email(RM_UI_Strings::get('LABEL_FROM_EMAIL'), "senders_email", array("id" => "id_rm_from_email_tb", "value" => $data['senders_email'], "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_FROM_EMAIL'), "required" => 1)));
