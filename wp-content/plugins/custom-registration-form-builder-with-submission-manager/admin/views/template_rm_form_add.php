...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Checkbox("<b>" . RM_UI_Strings::get('LABEL_CREATE_WP_ACCOUNT') . "?</b>(" . RM_UI_Strings::get('LABEL_CREATE_WP_ACCOUNT_DESC') . "):", "form_type", array(1 => ""), array("id" => "rm_user_create", "value" => $data->model->form_type, "longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_CREATE_WP_USER'))));


        $form->addElement(new Element_HTML('<div class="childfieldsrow">'));


        $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_DO_ASGN_WP_USER_ROLE') . ":</b>", "default_form_user_role", $data->roles, array("id" => "rm_user_role", "disabled" => 1, "longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_WP_USER_ROLE_AUTO') . "<br><br>" . RM_UI_Strings::get('MSG_BUY_PRO_INLINE'))));
        ...
        $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_USER_REDIRECT') . ":</b>", "form_redirect", array('none' => 'None', 'page' => 'Page', 'url' => 'URL'), array("id" => "rm_", "value" => $data->model->form_redirect? : 'none', "required" => "1", "longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_REDIRECT_AFTER_SUB'))));
        ...
        $form->addElement(new Element_Checkbox("<b>" . RM_UI_Strings::get('LABEL_AUTO_REPLY') . ":</b>", "form_should_send_email", array(1 => ""), array("id" => "rm_ss", "onclick" => "rm_toggle(    this, 'rm_auto_reply')", "value" => $data->model->form_should_send_email, "longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_AUTO_RESPONDER'))));
        ...
        $form->addElement(new Element_Checkbox("<b>" . RM_UI_Strings::get('LABEL_OPT_IN_CB') . ":</b>", "form_is_opt_in_checkbox", array(1 => ""), array("id" => "rm_", "value" => $data->model->form_options->form_is_opt_in_checkbox, "longDesc" => RM_UI_Strings::get('HELP_OPT_IN_CB'))));
        ...
        $form->addElement(new Element_Checkbox("<b>" . RM_UI_Strings::get('LABEL_AUTO_EXPIRE') . ":</b>", "form_should_auto_expire", array(1 => ""), array("id" => "rm_", "value" => $data->model->form_should_auto_expire, "longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_AUTO_EXPIRE'))));
...
//options for export submissions to url
        $options_send_to_url_field = array("id" => "rm_export_sub_url", "longDesc" => RM_UI_Strings::get('HELP_SEND_SUB_TO_URL'). "<br><br>" . RM_UI_Strings::get('MSG_BUY_PRO_INLINE'));
        ...
        $form->addElement(new Element_Url("<b>" . RM_UI_Strings::get('LABEL_EXPORT_URL') . ":</b>", "", $options_send_to_url_field));
