...
JS;
		...
		if(!in_array("focus", $this->prevent) || (isset($_SESSION["pfbc"][$id]["errors"]) && count($_SESSION["pfbc"][$id]["errors"]) !== 0))
...
JS;
	...
	public static function _setSessionValue($id, $element, $value) {
		$_SESSION["pfbc"][$id]["values"][$element] = RM_Utilities::trim_array($value);
	}
