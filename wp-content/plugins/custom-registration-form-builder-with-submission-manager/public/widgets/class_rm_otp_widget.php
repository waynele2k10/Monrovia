       ...
       <form method="post" action="" onsubmit="return false">
           <div id="rm_otp_login">
               <input type="text" placeholder="<?php _e('Email:',''); ?>" value="" id="rm_otp_econtact" name="<?php echo wp_generate_password(5, false,false); ?>"
                      onkeypress="return rm_call_otp(event)" maxlength="50"/>
               <input type="text" value="" placeholder="<?php _e('OTP:',''); ?>" maxlength="50" name="<?php echo wp_generate_password(5, false,false); ?>" id="rm_otp_kcontact" class="rm_otp_key" style="display:none" onkeypress="return rm_call_otp(event)"/>
