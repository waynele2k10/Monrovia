...
//var_dump($details['submit_time']);echo"<br>ONErun<br><br>";
            ...
            {
                $browser = new Browser($details['Browser']);
            ...
            foreach ($this->all_forms as $form_id)
            {
                ...
                if (!in_array($form_id, $this->created))
                {
                    $wpdb->insert(
                        ...
                        'is_field_primary' => 1,
                        'field_options' => 'O:8:"stdClass":9:{s:17:"field_placeholder";s:5:"Email";s:19:"field_default_value";N;s:15:"field_css_class";s:22:"rm_form_default_fields";s:16:"field_max_length";N;s:22:"field_textarea_columns";N;s:19:"field_textarea_rows";N;s:17:"field_is_required";i:1;s:18:"field_is_read_only";i:0;s:21:"field_is_other_option";N;}'
                            ), array(
                        '%d',
                        '%s',
                        '%s',
