...
class CFDBViewWhatsInDB extends CFDBView {
    ...
    <?php
		...
		<?php 
			...
			$uploads_url = $_upload_dir['baseurl'] . '/contact-form-uploads/';
		?>
        <script type="text/javascript">
            (function ($) {
				...
				$('td[title="multifile-upload"] div').each(
					function () {
						var html_body = '';
						var uploads = $(this).html().split(", ");
						for (index=0;index < uploads.length;index++) {
							console.log(uploads[index]);
							html_body += '<a href="<?php echo $uploads_url ?>'+uploads[index]+'">'+uploads[index]+'</a><br/>';
						}
						$(this).html(html_body);
					}
				);
            ...
            <tr>
                <td align="center" colspan="4">
                    <span style="font-size:x-small; font-style: italic;">
                        ...
                        <a target="_gravityforms" href="https://wordpress.org/plugins/tags/gravity-forms/">Gravity Forms</a>,
