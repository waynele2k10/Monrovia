...
<div class="item" >
	...
	<div class="item-wrap">
		<div class="feature">
			<img src="<?php echo $slider['home_slide_feature_desktop_image'][1]['original']; ?>" width="590" height="440" class="image" alt="<?php echo $slider['home_slide_feature_title'][1]?>" />
			<div class="content">
		...
		<div class="right">
			...
			<div class="bottom">
				<img src="<?php echo $slider['home_slide_bottom_right_desktop_image'][1]['original']; ?>" width="390" height="220" class="iamge" alt="<?php echo $slider['home_slide_bottom_right_title'][1]?>" />
				<div class="content">
