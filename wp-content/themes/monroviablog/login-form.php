...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'login' ); ?>" method="post">
		...
		<p class="forgetmenot">
			...
			<input name="rememberme" type="checkbox" id="rememberme<?php $template->the_instance(); ?>" value="forever" /><span></span>
			
			<label for="rememberme<?php $template->the_instance(); ?>"><?php esc_attr_e( 'Remember Me' ); ?></label>
            <span class="forgot">&nbsp;|&nbsp;&nbsp;<a href="<?php echo get_permalink(409); ?>" title="Forgot Password">Forgot my password</a></span>
		</p>
		<p class="submit">
...
<script type="text/javascript">
	jQuery( document ).ready(function() {
    	jQuery('input[type="checkbox"]').wrap('<div class="checkwrap"></div>').after('<span />');
	});
