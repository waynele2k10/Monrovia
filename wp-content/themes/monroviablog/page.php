        ...
        <?php if (have_posts()) : ?>
            ...
            <?php while (have_posts()) : the_post(); ?>
				...
				<?php if (has_post_thumbnail()) : ?>
					<?php $att = get_post_meta(get_the_ID(),'_thumbnail_id',true);
					$thumb = get_post($att);
						...
						<div class="row">
							<div class="col-md-12">
								<p class="date">
									...
									<?php endif; ?>
									<a href="<?php echo get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename')); ?>"><?php the_author(); ?></a> | <a href="<?php echo get_day_link(get_the_time('Y'), get_the_time('m'), get_the_time('d')); ?>" title="date"><?php the_time('F j, Y') ?></a>
								</p>
							</div>
						</div>
					</div>
