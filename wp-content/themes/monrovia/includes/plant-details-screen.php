		...
		if(in_array($plantStatus, $statusArray)){
                ...
                <div class="plant-messaging clearfix" data-item="<?php echo $record->info['item_number'];?>" data-status="<?php echo $status?>">
						...
						<script type="text/javascript"> 
							...
							if(getCookie('zip_code') != '' && getCookie('zip_code') != undefined){
								...
								isPlantLocal('<?php echo $record->info['item_number'];?>','<?php echo $isThirdParty ?>',postalCode,'<?php echo $status ?>');
							} else {
            ...
            <?php //Disable button if already added to favorites
				...
				<?php } else { ?>
                		...
                		<a class="fav-icon favorite" title="Add this plant to your favorite list and receive availability notifications." href="javascript:void(0);"  data-action="add">Add to Favorites <i class='fa fa-angle-double-right'></i></a>
                		<div class="favorite-tip">
	                		<a class="question"><i class="fa fa-question-circle"></i></a>
					    	<div class="tool-tip zone-tip" style="width: 218px;line-height: 20px;">
					    		<div class='tip-content'><span class='tip-close'><i class='fa fa-times-circle'></i></span>
					    			Add this plant to your favorite list and receive availability notifications.	
					    		</div>
					    	</div>
				    	</div>
               <?php } ?>
            <?php } else {  ?>
					...
					<a class="fav-icon favorite" title="Add this plant to your favorite list and receive availability notifications." href="/community/login/?notice=wishlist">Add to Favorites <i class='fa fa-angle-double-right'></i></a>
					<div class="favorite-tip">
                		<a class="question"><i class="fa fa-question-circle"></i></a>
				    	<div class="tool-tip zone-tip" style="width: 218px;line-height: 20px;">
				    		<div class='tip-content'><span class='tip-close'><i class='fa fa-times-circle'></i></span>
