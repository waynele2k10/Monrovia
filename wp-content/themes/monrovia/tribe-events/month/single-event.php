...
$state =  get_post_meta( $venueID, '_VenueState', true );
...
<div id="tribe-events-event-<?php echo $event_id ?>" class="<?php tribe_events_event_classes() ?>">
	<h3 class="tribe-events-month-event-title summary"><a href="<?php tribe_event_link( $post ); ?>" class="url"><?php the_title(); echo '<br />'.tribe_get_city( $post->ID ).', '.$state ?> </a></h3>
