...
?>
<?php the_breadcrumb($event_id, 'event'); //Print the Breadcrumb ?>
<!-- Tribe Bar -->
<div class="single-event"><?php tribe_get_template_part( 'modules/bar' ); ?></div>
...
<script>
	jQuery(window).load( function($){
		jQuery('.tribe-bar-active').removeClass('tribe-bar-active');
	});
</script>
