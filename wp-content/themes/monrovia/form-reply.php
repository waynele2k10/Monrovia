...
<?php if ( bbp_current_user_can_access_create_reply_form() ) : ?>
	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<p class="message"><?php _e( 'This topic is marked as closed to new replies, however your posting capabilities still allow you to do so.', 'bbpress' ); ?></p>
				...
				<div>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
						...
						<p>
							<label for="bbp_topic_tags" class="block-label"><?php _e( 'Tags:', 'bbpress' ); ?></label><br />
