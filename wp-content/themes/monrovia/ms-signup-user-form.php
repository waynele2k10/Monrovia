...
<form id="registerform" method="post" action="<?php $template->the_action_url( 'register' ); ?>">
	...
	<input name="user_name" type="text" id="user_name<?php $template->the_instance(); ?>" class="input cimy_uef_input_mu" value="<?php echo esc_attr( $user_name ); ?>" size="20" /><br />
	</p>
	<p>
	...
	<input name="user_email" type="text" id="user_email<?php $template->the_instance(); ?>" class="input cimy_uef_input_mu" value="<?php echo esc_attr( $user_email ); ?>" maxlength="256" size="20" /><br />
	</p>
