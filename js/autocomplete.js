...
Autocomplete.prototype = {
  ...
  processResponse: function(xhr) {
    var response;
    try {
      response = window.eval(xhr.responseText);
  ...
  select: function(i) {
    ...
    if (selectedValue) {
	  ...
	  this.el.value = this.htmlEntityDecode(selectedValue);
  ...
  moveUp: function() {
    ...
    if (this.selectedIndex === 0) {
      ...
      this.selectedIndex = -1;
	  this.el.value = this.htmlEntityDecode(currentValue);
      //this.el.value = this.currentValue;
      return;
    }
  ...
  adjustScroll: function(i) {
	...
	this.el.value = this.htmlEntityDecode(this.suggestions[i]);
