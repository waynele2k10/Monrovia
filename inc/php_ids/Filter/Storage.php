...
class IDS_Filter_Storage
{
    ...
    public final function __construct(IDS_Init $init)
    {
        if ($init->config) {
            ...
            if ($caching && $caching != 'none') {
                ...
                include_once $GLOBALS['server_info']['physical_root'].'inc/php_ids/Caching/Factory.php';
    ...
    public function getFilterFromXML()
    {
        ...
        if (extension_loaded('SimpleXML')) {
            ...
            include_once $GLOBALS['server_info']['physical_root'].'inc/php_ids/Filter.php';
    ...
    public function getFilterFromJson()
    {
        ...
        if (extension_loaded('Json')) {
            ...
            if (!$filters) {
                if (file_exists($this->source)) {
                    $filters = from_json(file_get_contents($this->source));
                } else {
                    throw new Exception(
